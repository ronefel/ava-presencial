    ...
    var usertours = {
        ...
        addResetLink: function() {
            ...
            .then(function(html, js) {
                 ...
                 * Adiciona um botão Ajuda em páginas que possuem tour
                 */
                $(".breadcrumb-button").last().prepend(
                '<button data-action="tool_usertours/resetpagetour" class="singlebutton"' +
                ' style="background-color: #990006; float:left; margin: 0;" value="Ajuda" type="submit"> ' +
                ' <i class="fa fa-question-circle fa-lg" style="margin-right:3px"></i> Ajuda</button>'
                );
