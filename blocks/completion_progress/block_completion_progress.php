...
class block_completion_progress extends block_base {
    ...
    public function get_content() {
        ...
        if (block_completion_progress_on_site_page()) {
            ...
            /**
             * Rone Santos
             * Libera o botão 'Visão Geral dos Estudantes' para o professor da disciplna
             * independente das permissões do papel 'professor'
             */
            if (has_capability('block/completion_progress:overview', $this->context) || block_user_has_role_in_course($USER->id, $COURSE->id, 'editingteacher')) {
