...
/**
 * Rone Santos
 * Se o usuário é professor da disciplina pula a verificação de permissão.
 * Professor sempre tem acesso independente de qualquer permissão.
 */
if(!block_user_has_role_in_course($USER->id, $courseid, 'editingteacher')){
