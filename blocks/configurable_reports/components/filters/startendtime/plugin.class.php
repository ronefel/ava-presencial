...
class plugin_startendtime extends plugin_base {
    ...
    public function execute($finalelements, $data) {
        ...
        $finalelements = str_replace('%%STARTTIME%%', $filterstarttime, $finalelements); // Rone Santos
        $finalelements = str_replace('%%ENDTIME%%', $filterendtime, $finalelements); // Rone Santos
    ...
    public function print_filter(&$mform) {
        ...
        /**
         * Rone Santos
         * Seta zero hora nos campos de data
         */
        $dt = new DateTime;
        $dt->setTime(0, 0);
        ...
        $mform->setDefault('filter_starttime', $time - 3600 * 24); // Rone Santos
        $mform->addElement('date_time_selector', 'filter_endtime', get_string('endtime', 'block_configurable_reports'));
        $mform->setDefault('filter_endtime', $time + 3600 * 24); // Rone Santos
    }
}
