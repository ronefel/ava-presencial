...
?>
    <script type="text/javascript">
        function printDiv(id){
            var cdiv, tmpw;
            const hrefStyle = getHrefStyle(); // Rone Santos

            cdiv = document.getElementById(id);
            tmpw = window.open(" ","Print");

            tmpw.document.open();
            tmpw.document.write(`<html><head><link rel="stylesheet" type="text/css" href="${hrefStyle}"></head><body>`); // Rone Santos
            ...
            /**
             * Rone Santos
             * Desativando o comando de imprir automático e de fechar a janela
             */
            // setTimeout(function() {
            //     tmpw.print();
            //     tmpw.close();
        ...
        /**
         * Rone Santos
         * Pega a folha de estilo principal
         */
        function getHrefStyle(){
            let href = '';
            let links = document.getElementsByTagName('link');
            for (let link of links){ 
                if(link.href.indexOf('theme/styles.php/lambda') !== -1){
                    href = link.href;
                } 
            }
            return href;
