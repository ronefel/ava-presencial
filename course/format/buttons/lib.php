...
class format_buttons extends format_topics {
    ...
    public function course_format_options($foreditform = false) {
        ...
        if ($foreditform && !isset($courseformatoptions['coursedisplay']['label'])) {
            ...
            $courseformatoptionsedit['sectiontype'] = array(
                ...
                'element_attributes' => array(
                    array(
                        'icon' => get_string('icon', 'format_buttons'), // Rone Santos - 05/12/2019
    ...
    /**
     * Rone Santos 02/03/2020
     * Um renderable para renderização do título do curso.
     */
    public function course_content_header(){
        $renderable = new format_buttons_header();
        return $renderable;
    }
}
 ...
 */
class format_buttons_header implements renderable {
    public $course;
