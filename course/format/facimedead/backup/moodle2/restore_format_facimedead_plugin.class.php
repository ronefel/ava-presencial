...
/**
 * Specialised restore for format_facimedead
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_format_facimedead_plugin extends restore_format_plugin {
    ...
    protected function update_automatic_end_date($enddate) {
        ...
        if (empty($enddate)) {
            ...
            format_facimedead::update_end_date($this->step->get_task()->get_courseid());
        } else {
            $update->value = 0;
            $DB->update_record('course_format_options', $update);
    ...
    public function after_restore_course() {
        ...
        $backupinfo = $this->step->get_task()->get_info();
        if ($backupinfo->original_course_format !== 'facimedead') {
