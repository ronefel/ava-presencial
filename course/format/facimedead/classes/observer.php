...
/**
 * Event observer for format_facimedead.
 *
 * @package format_facimedead
 * @copyright 2017 Mark Nelson <markn@moodle.com>
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class format_facimedead_observer {
    ...
    public static function course_updated(\core\event\course_updated $event) {
        if (class_exists('format_facimedead', false)) {
            // If class format_facimedead was never loaded, this is definitely not a course in 'facimedead' format.
            // Course may still be in another format but format_facimedead::update_end_date() will check it.
            format_facimedead::update_end_date($event->courseid);
        }
    }
