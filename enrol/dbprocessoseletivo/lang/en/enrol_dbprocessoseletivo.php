...
$string['created_from_dbprocessoseletivo'] = 'Created from enrol_dbprocessoseletivo';
...
$string['remotegroupfield_desc'] = 'the name of the group field that we use to create and assign groups to users.';
...
$string['templatecourseextensao'] = 'Novo modelo de curso - Extensão';
$string['templatecourseextensao_desc'] = '';
