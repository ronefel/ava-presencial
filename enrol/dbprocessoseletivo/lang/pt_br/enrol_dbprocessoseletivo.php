...
/**
 * Strings for component 'enrol_dbprocessoseletivo', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   enrol_dbprocessoseletivo
...
$string['created_from_dbprocessoseletivo'] = 'Criado com Banco de Dados Externo - Processos seletivos';
...
$string['pluginname'] = 'Banco de dados - Processo Seletivo';
...
$string['remotegroupfield'] = 'Campo "grupo" da tabela remota.';
$string['remotegroupfield_desc'] = 'O nome do campo que tem o nome dos grupos que seão criados e atribuídos.';
$string['remoteenroltimefield'] = 'Campo remoto para tempo de inscrição';
$string['remoteenroltimefield_desc'] = 'Campo da tabela remota que indica o tempo que o usuário ficará inscrito no curso';
...
$string['templatecoursextensao'] = 'Novo modelo de curso - Extensão';
