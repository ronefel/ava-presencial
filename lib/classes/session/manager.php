...
class manager {
    ...
    public static function login_user(\stdClass $user) {
        ...
        /**
         * Rone Santos - 05/11/2019
         * Desativando a inscrição do usuário nos cursos após o login
         * Apenas a axecução da tarefa agenda 'dbextended' poderá inscrever o usuário nos cursos
         */
