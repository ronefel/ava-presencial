...
abstract class enrol_plugin {
     ...
     * 
     * Rone Santos
     * Adicionando RA e turma_disciplina na inscrição
     */
    public function enrol_user(stdClass $instance, $userid, $roleid = null, $timestart = 0, $timeend = 0, $status = null, $recovergrades = null, $ra = NULL, $turmadisc = NULL) {
     ...
     * Adicionando RA e turma_disciplina na inscrição
     */
    public function update_user_enrol(stdClass $instance, $userid, $status = NULL, $timestart = NULL, $timeend = NULL, $ra = NULL, $turma_disciplina = NULL) {
        global $DB, $USER, $CFG;
         ...
         * Adicionando RA e turma_disciplina na inscrição
         */
        if (isset($ra) and $ue->ra != $ra) {
            $ue->ra = $ra;
            $modified = true;
        }
        if (isset($turma_disciplina) and $ue->turma_disciplina != $turma_disciplina) {
            $ue->turma_disciplina = $turma_disciplina;
            $modified = true;
        }
