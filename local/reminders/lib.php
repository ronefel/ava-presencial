    ...
    foreach ($upcomingevents as $event) {
        ...
        try {
            ...
            switch ($event->eventtype) {
                ...
                case 'course':
                    /**
                     * Rone Santos - 16/10/2019
                     * Só envia evento de curso visível
                     */
                    $course = $DB->get_record('course', array('id' => $event->courseid, 'visible' => 1));
                ...
                case 'due':
                    ...
                    if (!isemptyString($event->modulename)) {
                        ...
                        /**
                         * Rone Santos - 16/10/2019
                         * Só envia email de evento de curso visível
                         */
                        if(!$course->visible){
                            mtrace("  [Local Reminder] The reminder of the event $event->id was not sent, the course is hidden.");
                            break;
                        }
