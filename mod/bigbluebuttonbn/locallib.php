...
function bigbluebuttonbn_get_recording_data_row_type($recording, $bbbsession, $playback) {
    ...
    /**
     * Rone Santos - 23/09/2019
     * Melhora a visualizção dos links na tela
     */
    ...
    $linkattributes = array(
        ...
        'data-href' => $href,
        'style' => 'margin-bottom: 4px;' // Rone Santos
      );

    /**
     * Rone Santos
     * Esta condição verifica se a url externa da web conferência está respondendo.
     * Tem um bug aqui com o curl do moodle.
     * Depois de atualizar o moodle tem que descomentar pra ver se foi resolvido.
     */
