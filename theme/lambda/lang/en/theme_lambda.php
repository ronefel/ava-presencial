...
<p>Compatibility: Moodle 2.5 - 3.7<br />Theme Version: 1.97<br />Parent theme: Bootstrapbase by Bas Brands<br />Built on: Essential by Julian Ridden</p>
</div>
<hr />
...
/* Rone Santos */
$string['slide_url_new_page'] = 'Abrir em uma nova página';
$string['slide_url_new_page_desc'] = 'Se marcado irá abrir a url acima em uma nova página.';
...
/* Rone Santos */
$string['slideshow_customtime'] ='Tempo para mudar de imagem';
$string['slideshow_customtime_desc'] ='Selecione o tempo, em segundos, que levará para passar para a próxima imagem.';
$string['slideshow_customtransPeriod'] ='Tempo de transição';
$string['slideshow_customtransPeriod_desc'] ='Selecione o tempo, em segundos, que levará o efeito de transição';
...
$string['region-content-pre'] = 'Conteúdo (centro)'; // content-pre é nescessário - Rone
$string['nextsection'] = '';
