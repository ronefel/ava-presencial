...
<div id="page" class="container-fluid">
	<!-- <div id ="page-header-nav" class="clearfix"> </div> --> <!-- Rone Santos -->
...
<?php if ($hasslideshow) { ?>
	(function($) {
		...
		$('#camera_wrap').camera({
			...
			minHeight: "50px", // Rone Santos - 21/11/2019
			time: <?php echo $customtime; ?>, // Rone Santos - 21/11/2019
			transPeriod: <?php echo $customtransPeriod; ?>, // Rone Santos - 21/11/2019
