...
<?php } ?>
    ...
    <?php if ($hasheading) {
		...
		// echo '<span id="slider-prev"></span><span id="slider-next"></span>'; Rone Santos
	} else {
		// echo '<div style="padding-bottom: 20px;"><span id="slider-prev"></span><span id="slider-next"></span></div>'; Rone Santos
	} ?>
	...
	/** 
	 * Rone Santos
	 * Muda a posição dos controles 
	 */ 
	?>
	<div style="position: relative; line-height: 1; margin-top: 5px; margin-bottom: 20px;">
