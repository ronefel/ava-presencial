...
<header class="navbar">
    ...
    <!-- 
        Rone Santos
        Avisa que o Caps Lock está ativo 
    -->
    <script>
        if(document.getElementById('div_capslock_ativa')){
            document.addEventListener( 'keydown', function( event ) {
                var caps = event.getModifierState && event.getModifierState( 'CapsLock' );
                if(caps){
                    document.getElementById('div_capslock_ativa').style.display = 'block';
                }else{
                    document.getElementById('div_capslock_ativa').style.display = 'none';
                }
            });
        }
    </script>
