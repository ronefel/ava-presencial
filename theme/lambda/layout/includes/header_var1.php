		...
		<div class="span6 login-header">
			<div class="profileblock">
						...
						<form class="navbar-form pull-right" method="post" action="<?php echo $wwwroot; ?>/login/index.php?authldap_skipntlmsso=1">
							<div id="block-login">
								...
								<?php
									/**
									 * Rone Santos
									 * Avisa que o Caps Lock está ativado
									 */
								?>
								<div id="div_capslock_ativa" style="display: none; background-color: rgb(248, 251, 223); border-radius: 2px; border: 1px solid rgb(226, 228, 86); font-size: 1rem; line-height: 24px; margin-top: -26px;">
									Tecla CAPS LOCK está ativada.
								</div>
								...
								<?php
									/**
									 * Rone Santos
									 * Adiciona o botão para salvar o login no cookie
									 */
								?>
								<div class="mt-1" style="display: flex; justify-content: flex-end;">
									<input type="checkbox" name="rememberusername" id="rememberusername" value="1">
									<label for="rememberusername">Mantenha-me logado</label>
								</div>
				...
				<?php } else {
					...
					echo $OUTPUT->user_picture($USER, array('size' => 60, 'class' => 'welcome_userpicture')); // Rone Santos
					echo '</div>';
