 ...
 */
$customtime = $PAGE->theme->settings->slideshow_customtime;
$customtransPeriod = $PAGE->theme->settings->slideshow_customtransPeriod;
			...
			<div data-src="<?php echo $PAGE->theme->setting_file_url('slide1image', 'slide1image'); ?>">
				<div class="camera_caption <?php echo $txtfx; ?>">
					...
					<?php if (!empty($PAGE->theme->settings->slide1_url)) { ?>
						<a class="slide-link" 
							<?php if ($PAGE->theme->settings->slide1_url_new_page) { ?>
								target="_blank"
							<?php } ?>
							href="<?php echo $PAGE->theme->settings->slide1_url; ?>"></a>
					<?php } ?>
					...
					?>
					<span style="display: none;"><?php echo $slidecaption_HTML; ?> <!-- Rone Santos -->
					<?php if (!empty($PAGE->theme->settings->slide1_url)) { ?>
			...
			<div data-src="<?php echo $PAGE->theme->setting_file_url('slide2image', 'slide2image'); ?>">
				<div class="camera_caption <?php echo $txtfx; ?>">
					...
					<?php if (!empty($PAGE->theme->settings->slide2_url)) { ?>
						<a class="slide-link" 
							<?php if ($PAGE->theme->settings->slide2_url_new_page) { ?>
								target="_blank"
							<?php } ?>
							href="<?php echo $PAGE->theme->settings->slide2_url; ?>"></a>
					<?php } ?>
			...
			<div data-src="<?php echo $PAGE->theme->setting_file_url('slide3image', 'slide3image'); ?>">
				<div class="camera_caption <?php echo $txtfx; ?>">
					...
					<?php if (!empty($PAGE->theme->settings->slide3_url)) { ?>
						<a class="slide-link" 
							<?php if ($PAGE->theme->settings->slide3_url_new_page) { ?>
								target="_blank"
							<?php } ?>
							href="<?php echo $PAGE->theme->settings->slide3_url; ?>"></a>
					<?php } ?>
			...
			<div data-src="<?php echo $PAGE->theme->setting_file_url('slide4image', 'slide4image'); ?>">
				<div class="camera_caption <?php echo $txtfx; ?>">
					...
					<?php if (!empty($PAGE->theme->settings->slide4_url)) { ?>
						<a class="slide-link" 
							<?php if ($PAGE->theme->settings->slide4_url_new_page) { ?>
								target="_blank"
							<?php } ?>
							href="<?php echo $PAGE->theme->settings->slide4_url; ?>"></a>
					<?php } ?>
			...
			<div data-src="<?php echo $PAGE->theme->setting_file_url('slide5image', 'slide5image'); ?>">
				<div class="camera_caption <?php echo $txtfx; ?>">
					...
					<?php if (!empty($PAGE->theme->settings->slide5_url)) { ?>
						<a class="slide-link" 
							<?php if ($PAGE->theme->settings->slide5_url_new_page) { ?>
								target="_blank"
							<?php } ?>
							href="<?php echo $PAGE->theme->settings->slide5_url; ?>"></a>
					<?php } ?>
