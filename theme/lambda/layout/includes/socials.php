<?php
/**
 * Rone Santos - 21/11/2019
 * Verifica se está acessando por dispositivo móvel para esconder os blocos na lateral
 */
...
<?php if ($hassocials) { ?>
    ...
    <?php if (($hassocials_mail||$haswebsite) && !$isSessionMobile) { ?>
    	<div class="span8"><!--  Rone - 21/11/2019 -->
        	<div class="social_contact">
            <?php if ($haswebsite) { ?>
            <nobr><i class="<?php echo $fa_site_icons; ?> fa-globe"></i> &nbsp;<a href='<?php echo $PAGE->theme->settings->website; ?>' target="_blank" class="social_contact_web"><?php echo $PAGE->theme->settings->website; ?></a></nobr>
            <?php 
			} ?>
        ...
        <div class="span4"><!--  Rone - 21/11/2019 -->
        <?php
        } else { ?>
		<div class="span12"> 
		<?php 
        	...
        	<div class="social_icons pull-right">
                <?php if ($haswebsite && $isSessionMobile) { ?><a class="social <?php echo $fa_site_icons; ?> fa-globe" href='<?php echo $PAGE->theme->settings->website; ?>' target="_blank"> </a><?php } ?>
                <?php if ($hassocials_mail && $isSessionMobile) { ?><a class="social <?php echo $fa_site_icons; ?> fa-envelope<?php echo $fa_site_icons_app; ?>" href='mailto:<?php echo $PAGE->theme->settings->socials_mail; ?>'> </a><?php } ?>
