...
$ADMIN->add('themes', new admin_category('theme_lambda', 'Theme-Lambda'));
    ...
    /**
     * Rone Santos - 02/12/2019
     * Informa se é para abrir a url em numa nova página
     */
    $name = 'theme_lambda/slide1_url_new_page';
    $title = get_string('slide_url_new_page', 'theme_lambda');
    $description = get_string('slide_url_new_page_desc', 'theme_lambda');
    $setting = new admin_setting_configcheckbox($name, $title, $description, 0);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $temp->add($setting);
     ...
     * Informa se é para abrir a url em numa nova página
     */
    $name = 'theme_lambda/slide2_url_new_page';
    $title = get_string('slide_url_new_page', 'theme_lambda');
    $description = get_string('slide_url_new_page_desc', 'theme_lambda');
    $setting = new admin_setting_configcheckbox($name, $title, $description, 0);
    $setting->set_updatedcallback('theme_reset_all_caches');
     ...
     * Informa se é para abrir a url em numa nova página
     */
    $name = 'theme_lambda/slide3_url_new_page';
    $title = get_string('slide_url_new_page', 'theme_lambda');
    $description = get_string('slide_url_new_page_desc', 'theme_lambda');
    $setting = new admin_setting_configcheckbox($name, $title, $description, 0);
    $setting->set_updatedcallback('theme_reset_all_caches');
     ...
     * Informa se é para abrir a url em numa nova página
     */
    $name = 'theme_lambda/slide4_url_new_page';
    $title = get_string('slide_url_new_page', 'theme_lambda');
    $description = get_string('slide_url_new_page_desc', 'theme_lambda');
    $setting = new admin_setting_configcheckbox($name, $title, $description, 0);
    $setting->set_updatedcallback('theme_reset_all_caches');
     ...
     * Informa se é para abrir a url em numa nova página
     */
    $name = 'theme_lambda/slide5_url_new_page';
    $title = get_string('slide_url_new_page', 'theme_lambda');
    $description = get_string('slide_url_new_page_desc', 'theme_lambda');
    $setting = new admin_setting_configcheckbox($name, $title, $description, 0);
    $setting->set_updatedcallback('theme_reset_all_caches');
    ...
    /**
     * Rone Santos - 22/11/2019
     * Adiciona configurações de tempo
     */
    // Slideshow Time 
    $name = 'theme_lambda/slideshow_customtime';
    $title = get_string('slideshow_customtime', 'theme_lambda');
    $description = get_string('slideshow_customtime_desc', 'theme_lambda');
    $default = '7000';
    $choices = array(
		3000=>'3s',
		4000=>'4s',
    ...
    $setting = new admin_setting_configselect($name, $title, $description, $default, $choices);
    $temp->add($setting);
    // Slideshow Transition Period 
    $name = 'theme_lambda/slideshow_customtransPeriod';
    $title = get_string('slideshow_customtransPeriod', 'theme_lambda');
    $description = get_string('slideshow_customtransPeriod_desc', 'theme_lambda');
    $default = '1500';
    $choices = array(
		500=>'0,5s',
		1000=>'1s',
